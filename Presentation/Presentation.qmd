...
#| echo: false
#| include: true
#| fig-cap: "Example of variance changepoint dataset. Between the 2 changepoint, the variance is 3 times higher than the rest of the series."
...
To prevent that, the *restarted* BOCD algorithm was developed by @restarted_alami_2020 which restarts all over again every time a changepoint is detected.
